...
// Bucket-interval math (resolveInterval, calcBucketInterval, fillEmptyBuckets,
// estimateBucketCount) lives in _histogramInterval.ts — pure, no React, so it's testable and
// importable without pulling in this component. Re-exported here so existing call sites
// (LogsExplorer, IntervalPicker) that import them from this module keep working unchanged.
export type { ResolvedInterval } from './_histogramInterval';
export {
  resolveInterval,
  calcBucketInterval,
  estimateBucketCount,
